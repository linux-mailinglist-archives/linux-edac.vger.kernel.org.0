...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C62EE59C863
	for <lists+linux-edac@lfdr.de>; Mon, 22 Aug 2022 21:16:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238349AbiHVTOx (ORCPT <rfc822;lists+linux-edac@lfdr.de>);
        Mon, 22 Aug 2022 15:14:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43744 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238269AbiHVTOl (ORCPT
        <rfc822;linux-edac@vger.kernel.org>); Mon, 22 Aug 2022 15:14:41 -0400
Received: from mail.baikalelectronics.com (mail.baikalelectronics.com [87.245.175.230])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 2BAE128E36;
        Mon, 22 Aug 2022 12:14:40 -0700 (PDT)
Received: from mail (mail.baikal.int [192.168.51.25])
        by mail.baikalelectronics.com (Postfix) with ESMTP id 80D82DA6;
        Mon, 22 Aug 2022 22:17:46 +0300 (MSK)
DKIM-Filter: OpenDKIM Filter v2.11.0 mail.baikalelectronics.com 80D82DA6
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=baikalelectronics.ru; s=mail; t=1661195866;
        bh=z4bJmTJq93ppPtElTBvIhg00dYF7lC245GPtGAEfv08=;
        h=From:To:CC:Subject:Date:In-Reply-To:References:From;
        b=lu39DrDC+YwrpOcwtl5utrdg2Gprn5rLupOp2g+E5hcMdPtrDD4J52I9nPBJciiji
         V4XLaTu31NPf3786GwXiv2HBgPxa3REJo3yAVvIqrXnZPrRA7jJRc5dnE3eca3xmKF
         yRNLj1/gyjmGHVRcKGnogPiND63qrVkIEYHrYumU=
...
Subject: [PATCH 04/18] EDAC/synopsys: Detach private data from mci instance
Date:   Mon, 22 Aug 2022 22:14:13 +0300
Message-ID: <20220822191427.27969-5-Sergey.Semin@baikalelectronics.ru>
...
---
 drivers/edac/synopsys_edac.c | 138 ++++++++++++++++++++++-------------
 1 file changed, 89 insertions(+), 49 deletions(-)

diff --git a/drivers/edac/synopsys_edac.c b/drivers/edac/synopsys_edac.c
index 1aaf355798bd..10dc9e9d66d9 100644
...
@@ -591,21 +621,36 @@ static void snps_init_csrows(struct mem_ctl_info *mci)
 }
...
@@ -625,24 +670,43 @@ static void snps_mc_init(struct mem_ctl_info *mci, struct platform_device *pdev)
...
+			       0, dev_name(&priv->pdev->dev), mci);
 	if (ret < 0) {
 		...
 		return ret;
@@ -1066,49 +1130,24 @@ static inline void snps_create_debugfs_nodes(struct mem_ctl_info *mci) {}
  */
...
@@ -1124,7 +1163,7 @@ static int snps_mc_probe(struct platform_device *pdev)
 	return 0;
...
@@ -1143,7 +1182,8 @@ static int snps_mc_remove(struct platform_device *pdev)
