Return-Path: <linux-edac+bounces-282-lists+linux-edac=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-edac@lfdr.de
Delivered-To: lists+linux-edac@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EEE3817A90
	for <lists+linux-edac@lfdr.de>; Mon, 18 Dec 2023 20:05:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id DE217281C6C
	for <lists+linux-edac@lfdr.de>; Mon, 18 Dec 2023 19:04:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 839C072054;
	Mon, 18 Dec 2023 19:04:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="pLaVokde"
X-Original-To: linux-edac@vger.kernel.org
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (mail-dm6nam12on2048.outbound.protection.outlook.com [40.107.243.48])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BE0615D74F;
	Mon, 18 Dec 2023 19:04:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=amd.com
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=i+fXlju+a6t4rl2Xu0BdSm9Gd4rRj03uvmbrSVPV8GA=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=i+fXlju+a6t4rl2Xu0BdSm9Gd4rRj03uvmbrSVPV8GA=;
 b=pLaVokdeZluNFCyztdLWHMxiN5DilwJQvzjF6GC2jUxrpT6MJUMt/NFUfACwBNFPQI7Hn4TOw+li2D89FB6l1xbMVRZatKsWkiwdgaUfhNeHwOcfn+cJgJ7OKxBQvN+OHCFfVlk1DrSG69SiJ4213mk30j6Wi7baDWG/pD1XtAU=
...
Received: from DS3PEPF000099D5.namprd04.prod.outlook.com
 (2603:10b6:5:bc:cafe::b6) by DM6PR13CA0001.outlook.office365.com
...
Received: from SATLEXMB04.amd.com (165.204.84.17) by
 ...
 15.20.7113.14 via Frontend Transport; Mon, 18 Dec 2023 19:04:20 +0000
...
Subject: [PATCH v4 1/3] RAS: Introduce AMD Address Translation Library
Date: Mon, 18 Dec 2023 13:04:04 -0600
Message-ID: <20231218190406.27479-2-yazen.ghannam@amd.com>
...
X-MS-TrafficTypeDiagnostic: DS3PEPF000099D5:EE_|MN2PR12MB4141:EE_
X-MS-Office365-Filtering-Correlation-Id: b70535eb-0146-4217-bc91-08dbfffc242d
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:165.204.84.17;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:SATLEXMB04.amd.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230031)(4636009)(376002)(39860400002)(346002)(136003)(396003)(230173577357003)(230922051799003)(230273577357003)(64100799003)(1800799012)(451199024)(82310400011)(186009)(40470700004)(46966006)(36840700001)(8676002)(8936002)(36860700001)(5660300002)(44832011)(47076005)(4326008)(6666004)(7696005)(83380400001)(316002)(54906003)(110136005)(70206006)(40480700001)(30864003)(70586007)(336012)(426003)(2906002)(82740400003)(41300700001)(356005)(81166007)(40460700003)(478600001)(966005)(1076003)(19627235002)(26005)(16526019)(2616005)(86362001)(36756003)(36900700001)(559001)(579004)(309714004);DIR:OUT;SFP:1101;
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Dec 2023 19:04:20.4219
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: b70535eb-0146-4217-bc91-08dbfffc242d
...
---
Link:
https://lore.kernel.org/r/20231210194932.43992-2-yazen.ghannam@amd.com
...
* Provide inline helper to do "config reachable" check.
 ...
 16 files changed, 3343 insertions(+)
...
index 164f57bcb9b3..9db88a691bdf 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -881,6 +881,12 @@ Q:	https://patchwork.kernel.org/project/linux-rdma/list/
...
new file mode 100644
index 000000000000..9cc31c052427
--- /dev/null
...
new file mode 100644
index 000000000000..fb182dd7cca6
--- /dev/null
...
new file mode 100644
index 000000000000..a1996811aa34
--- /dev/null
...
new file mode 100644
index 000000000000..8145b7bb2b40
--- /dev/null
...
new file mode 100644
index 000000000000..37ad203bb93e
--- /dev/null
...
new file mode 100644
index 000000000000..aafe6ea95a23
--- /dev/null
...
index 95540ea8dd9d..e3162f2c9979 100644
--- a/drivers/ras/ras.c
+++ b/drivers/ras/ras.c
@@ -10,6 +10,37 @@
 #include <linux/ras.h>
...
index 1f4048bf2674..829252a358b7 100644
