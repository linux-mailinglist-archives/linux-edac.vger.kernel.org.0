...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B78A145A685
	for <lists+linux-edac@lfdr.de>; Tue, 23 Nov 2021 16:28:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236502AbhKWPbk (ORCPT <rfc822;lists+linux-edac@lfdr.de>);
        Tue, 23 Nov 2021 10:31:40 -0500
Received: from ipv6test5.plus.com ([81.174.144.187]:44244 "EHLO
        ipv6test5.plus.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236264AbhKWPbk (ORCPT
        <rfc822;linux-edac@vger.kernel.org>); Tue, 23 Nov 2021 10:31:40 -0500
X-Greylist: delayed 483 seconds by postgrey-1.27 at vger.kernel.org; Tue, 23 Nov 2021 10:31:39 EST
Received: from [IPv6:2001:470:1b4a::e9a] (colonelk.lan [IPv6:2001:470:1b4a::e9a])
        by ipv6test5.plus.com (Postfix) with ESMTPSA id BEA714960C47;
        Tue, 23 Nov 2021 15:20:24 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=buttersideup.com;
        s=2021022401; t=1637680826; h=from:from:sender:reply-to:subject:subject:date:date:
         message-id:message-id:to:to:cc:cc:mime-version:mime-version:
         content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=IMSj+1/6Vg+qiILcqDFqYW+vxdc/axx98MXIHYfPh1U=;
        b=rF0+4chDyqOQsMflszSPyfNojovJblddz4K7KWK7yLLE4aTrzstydnWaUL3D1SU8JwnIV9
        hIaquVmnFl9k7TzBnWLxKZI3L1f9afkujbjquw9LSIZ3V2J8+QgJnauFdE1yYF7DHq6FlP
        Oc5xmKbTl2NFjmoMCy1uRIGp5ICXTa4=
...
Message-ID: <22f56ee7-8e8f-0e05-850f-f8008a8e8b12@buttersideup.com>
Date:   Tue, 23 Nov 2021 15:20:24 +0000
...
Yeah seems reasonable to remove this at this stage.

I know of at least one organisations which had some large installs using
this driver (which could trivially be enabled if you didn't care about
agp graphics) and I suspect that this hardware probably lives on in some
embedded systems, but they're probably not getting new kernels these days.

Thanks for the clean-up effort.

Acked-by: Tim Small <tim@buttersideup.com>

Tim.

On 23/11/2021 15:06, Paul Gortmaker wrote:
